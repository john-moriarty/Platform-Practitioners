...
const roles = {
  "SW Developer (external)": {
    type: "e2e",
    type: "developer",
    x: 10,
    y: 92,
    description:
      "Develops external-facing apps, leveraging pre-trained models with limited customization. Typically integrates models via API.",
  ...
  "Site Reliability Eng (SRE)": {
    ...
    y: 65,
    description:
      "Ensures platform reliability, scaling, and performance optimization. Key for maintaining production-grade AI systems. Cross-platform, code-first users.",
    target: "targetUsers",
  },
  "Security Engineer / InfoSec": {
    ...
    y: 55,
    description:
      "Manages security compliance, conducts vulnerability assessments, and oversees access control for AI systems. Config & admin focus.",
    target: "targetUsers",
  },
  "System admin / Corporate IT": {
    ...
    y: 35,
    description:
      "Manages internal IT systems, supports platform access, and ensures operational continuity. Config & admin focus.",
    target: "targetUsers",
  },
  "Business stakeholders": {
    ...
    y: 10,
    description:
      "Leverages analytics for strategic decision-making; does not directly engage in model development or platform operations. Consumes platform outputs such as apps and reports.",
    target: "nonTargetUsers",
  },
  "SW Developer (internal)": {
    type: "e2e",
    type: "developer",
    x: 25,
    y: 85,
    description:
      "Builds internal-facing applications, often involving significant customization of models / LLM blueprints and data pipelines. Code-first/API user, uses Console for monitoring.",
    target: "targetUsers",
  },
  "Model risk manager / AI governance": {
    ...
    y: 30,
    description:
      "Oversees model validation, governance, and regulatory compliance, ensuring operational risk management.",
    target: "targetUsers",
  },
  "Ethics & fairness specialist": {
    type: "govern",
    type: "governer",
    x: 40,
    y: 20,
    description:
      "Focuses on ensuring ethical AI practices, reducing bias, and promoting fairness in models. Evaluates data and model outputs for compliance with regulatory and ethical standards. Common in regulated industries",
    target: "targetUsers",
  },
  "AI Product manager": {
    type: "e2e",
    ...
    y: 40,
    description:
      "Defines product requirements, bridges technical and business needs, and collaborates with AI/ML teams to align on performance and limitations.",
    target: "nonTargetUsers",
  },
  "Data engineer": {
    type: "build",
    ...
    y: 70,
    description:
      "Builds and maintains data pipelines, ensuring data quality, validation, and readiness for AI workflows.",
    target: "targetUsers",
  },
  "Mid-level data scientist": {
    ...
    y: 50,
    description:
      "Typically code-first practitioners using libraries, APIs, and SDKs to build and validate AI/ML models.",
    target: "targetUsers",
  },
  "MLOps engineer": {
    type: "govern",
    ...
    y: 74,
    description:
      "Specializes in model deployment, monitoring, and orchestration. Implements CI/CD pipelines tailored for ML workflows.",
    target: "targetUsers",
  },
  "ML engineer": {
    type: "govern",
  ...
  "Internal users (CFDS)": {
    ...
    y: 65,
    description:
      "Primarily demo-focused users with unique requirements; tracked independently from commercial customers.",
    target: "nonTargetUsers",
  },
  "Decision scientist": {
    type: "e2e",
    ...
    y: 40,
    description:
      "Translates raw data insights into actionable business strategies and recommendations.",
    target: "nonTargetUsers",
  },
  "Data analyst": {
    type: "build",
    ...
    y: 35,
    description:
      "Uses low-code tools to derive insights from data; may rely on AutoML for model generation.",
    target: "nonTargetUsers",
  },
  "Advanced data scientist": {
    ...
    y: 55,
    description:
      "Develops foundational models in large organizations and oversees their deployment into production. ",
    target: "targetUsers",
  },
...
const filterTypes = {
  developer: { label: "AI App Developers", color: "#5C41FF" },
  specialist: { label: "AI/ML Specialist", color: "#F764B5" },
  builder: { label: "Data and AI/ML Builders", color: "#81FBA5" },
  governer: { label: "AI Risk & Governance", color: "#44BFFC" },
  operations: { label: "AI Ops & Infrastructure", color: "#EAEA28" },
  consumer: { label: "consumer", color: "#E4E4E4" },
};
...
const PractitionerLandscape = () => {
  ...
  const filteredRoles = Object.entries(roles).filter(([name, role]) => {
    ...
    return (
      activeFilters.includes(role.type) || activeFilters.includes(role.target)
    );
  });
      ...
      <div className="flex">
        <div className="flex flex-col gap-4 p-8">
          <h3 className="text-sm font-semibold text-gray-800 mb-2">
            Current and target DataRobot users <br />
          </h3>
          <h3 className="text-sm text-gray-500 mb-3">
            Click buttons below to filter results
            <br />
            Hover roles to see more detail
            <br />
          </h3>
          {["targetUsers", "nonTargetUsers"].map((key) => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-300 transition-colors ${
                activeFilters.includes(key) ? "bg-gray-100" : "hover:bg-gray-50"
              }`}
            >
              <span className="text-sm font-bold">
                {key === "targetUsers" ? "Primary target" : "Secondary target"}
              </span>
            </button>
          ))}
